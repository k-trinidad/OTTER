...
std::string windowTitle = "Kyra Trinidad - 100784182";
...
int main() {
	...
	//VBO - Vertex buffer object 
	VertexBuffer* posVbo2 = new VertexBuffer();
	posVbo2->LoadData(points2, 9);

	VertexBuffer* color_vbo2 = new VertexBuffer();
	...
	static const float interleaved[] = {
		// X     Y     Z     R     G     B
		0.6f, -0.5f, 0.5f, 1.0f, 0.3f, 1.0f,
		0.6f,  0.5f, 0.5f, 0.5f, 0.0f, 0.5f,
		0.8f,  0.5f, 0.5f, 1.0f, 0.0f, 0.5f,
		0.8f, -0.5f, 0.5f, 1.0f, 1.0f, 1.0f
	};
	...
	Shader* shader2 = new Shader(); //second shader
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//Shape 2
		shader2->Bind(); //second fragment shader (more dull)
		vao3->Bind();
		glDrawArrays(GL_TRIANGLES, 0, 3);
